                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <table id="datatablesSimple">
                            ...
                            <tbody>
                            <c:choose>
                                <c:when test="${listClasses == null}">
                                    <tr>
                                        <td>There are no classes available</td>
                                    </tr>
                                </c:when>
                            </c:choose>
                            ...
                            <c:forEach var="classes" items="${listClasses}"
                                ...
                                <tr>
                                    ...
                                    <td>${classes.getNumberOfStudent}</td>
                                    <td>
                                        <a href="#"><i class="fa fa-eye" aria-hMaGVden="true"></i></a>
                                        <a href="/projectAPI/admin/teachers/update?id=${classes.getId()}"><i
                                                class="fa fa-retweet" aria-hMaGVden="true"></i></a>
                                        <a href="/projectAPI/admin/teachers/delete?id=${classes.getId()}"
