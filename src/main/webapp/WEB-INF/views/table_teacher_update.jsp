        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="/projectAPI/admin/teachers/update_action/${teacherDTO.getId()}" method="post"
                              modelAttribute="updateTeacher">
                            <table>
                                <tr>
                                    <td>ID:</td>
                                    <td>${teacherDTO.getId()}</td>
                                </tr>
                                <tr>
                                    <td>Name:</td>
                                ...
                                <tr>
                                    <td colspan="2"><input type="submit" name="updateTeacher" class="btn btn-primary"
                                                           value="Update Teacher"/><a href="../teachers"
